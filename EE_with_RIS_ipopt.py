...
def With_RIS_ipopt(Bandwidth, Noise, P_max, P_k, mu, PathLoss_UserBS, PathLoss_UserRIS, PathLoss_RISBS, xonoff,
    ...
    # opt.options['bonmin.algorithm'] = 'B-ECP'
    #----------------solver options --------------#
    
    opt.options['max_iter'] = int(0.5*1e2)
    ...
    opt.options['nlp_scaling_max_gradient'] = int(5)
    ...
    print("--------With RIS ipopt Solved--------")
    print("With RIS ipopt status :", primal_prob_status)
    print("With RIS ipopt time :", PP_solvertime)
    
    return  primal_prob_status, prob_lower_bound
