...
#-----------------multi-cut GBD function for training-----------------------# 
...
# from ee_features_labels_cal import Master_class
from EE_multi_collectdata_v2 import Master_class
...
def gbd_multi_col_train(Bandwidth0, Noise0, P_max0, P_k0, mu0, RIS_Lnum0, Tx_antBS0, Tx_antRIS0, Num_User0, 
              PathLoss_UserBS0, PathLoss_UserRIS0, PathLoss_RISBS0, xonoffini, power_P0,  PU_SINR_min0, numsol, threshold, p_i,
    ...
    for idx_inisol in range(numsol):
        ...
        theta_PU_SU_primal, theta_PU_SU_primal_dual, power_S_opt, power_SU_dual, PU_SINR_dual, PU_signal_dual,\
            prob_exitflag_power, prob_LowerBound, PP_solver_time, PP_time\
        ...
        # print("feasible_flag_multi", one_feasible_flag_multi[idx_inisol])
        ...
        # thetavec_PU_SU_primaldual_multi = np.array(theta_PU_SU_primal_phasedual).reshape(1,Tx_antRIS,1)
        ...
        # PU_SINR_multi = np.array(PU_SINR).reshape(1,1)
    ...
    rho_new, psi, numsol_real = master_class.master_sol(one_feasible_flag_multi,one_thetavec_PU_SU_primal_multi, one_thetavec_PU_SU_primal_dual_multi,
                   one_power_SU_primal_multi, one_power_SU_primal_dual_multi, one_PU_SINR_primal_dual_multi, one_PU_signal_primal_dual_multi,
                   one_infeasible_alpha_multi, numsol, xonoff, threshold)
    ...
    while ((upper_bound-lower_bound)/abs(lower_bound)>1e-7) and (i_gbd<max_iter_num):
		...
		#----------------solve the relaxed master problem-------------------#
        #        
        rho_new, psi, numsol_real_new = master_class.master_sol(feasible_flag_multi,thetavec_PU_SU_primal_multi, thetavec_PU_SU_primal_dual_multi,
            power_SU_primal_multi, power_SU_primal_dual_multi, PU_SINR_primal_dual_multi, PU_signal_primal_dual_multi,
            infeasible_alpha_multi, numsol, rho, threshold)
